...
public class ClimaService {
    ...
    public String obtenerClima() {
        try {
            ...
            System.out.println("🌤️ Consultando clima para " + CIUDAD + "...");
            ...
            System.err.println("⚠️ Error al obtener clima: " + e.getMessage());
            return "No disponible";
        }
    }

    /**
     * Obtiene el clima actual con temperatura
     * @return Descripción del clima con temperatura o "No disponible" si falla
     */
